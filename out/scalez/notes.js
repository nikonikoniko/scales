...
cljs.spec.alpha.def_impl(cljs.core.cst$kw$scalez$notes_SLASH_named_DASH_note,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_keys,cljs.core.cst$kw$req,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scalez$notes_SLASH_step,cljs.core.cst$kw$scalez$notes_SLASH_total,cljs.core.cst$kw$scalez$notes_SLASH_name], null),cljs.core.cst$kw$opt,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$scalez$notes_SLASH_flat_DASH_of_DASH_name,cljs.core.cst$kw$scalez$notes_SLASH_sharp_DASH_of_DASH_name], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$req_DASH_un,cljs.core.cst$kw$opt_DASH_un,cljs.core.cst$kw$gfn,cljs.core.cst$kw$pred_DASH_exprs,cljs.core.cst$kw$keys_DASH_pred,cljs.core.cst$kw$opt_DASH_keys,cljs.core.cst$kw$req_DASH_specs,cljs.core.cst$kw$req,cljs.core.cst$kw$req_DASH_keys,cljs.core.cst$kw$opt_DASH_specs,cljs.core.cst$kw$pred_DASH_forms,cljs.core.cst$kw$opt],[null,null,null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__7627){
return cljs.core.map_QMARK_(G__7627);
}),(function (G__7627){
return cljs.core.contains_QMARK_(G__7627,cljs.core.cst$kw$scalez$notes_SLASH_step);
}),(function (G__7627){
return cljs.core.contains_QMARK_(G__7627,cljs.core.cst$kw$scalez$notes_SLASH_total);
}),(function (G__7627){
return cljs.core.contains_QMARK_(G__7627,cljs.core.cst$kw$scalez$notes_SLASH_name);
})], null),(function (G__7627){
return ((cljs.core.map_QMARK_(G__7627)) && (cljs.core.contains_QMARK_(G__7627,cljs.core.cst$kw$scalez$notes_SLASH_step)) && (cljs.core.contains_QMARK_(G__7627,cljs.core.cst$kw$scalez$notes_SLASH_total)) && (cljs.core.contains_QMARK_(G__7627,cljs.core.cst$kw$scalez$notes_SLASH_name)));
...
var G__7631 = cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(n);
var G__7632 = cljs.core.cst$kw$step.cljs$core$IFn$_invoke$arity$1(n);
var G__7633 = cljs.core.cst$kw$range.cljs$core$IFn$_invoke$arity$1(n);
var G__7634 = cljs.core.cst$kw$flat_DASH_of_DASH_name.cljs$core$IFn$_invoke$arity$1(n);
var G__7635 = cljs.core.cst$kw$sharp_DASH_of_DASH_name.cljs$core$IFn$_invoke$arity$1(n);
return (scalez.notes.log.cljs$core$IFn$_invoke$arity$5 ? scalez.notes.log.cljs$core$IFn$_invoke$arity$5(G__7631,G__7632,G__7633,G__7634,G__7635) : scalez.notes.log.call(null,G__7631,G__7632,G__7633,G__7634,G__7635));
});
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__7636_SHARP_){
return scalez.notes.same_note_QMARK_(p1__7636_SHARP_,n);
}),notes));
});
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__7637_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(name,cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(p1__7637_SHARP_));
}),notes));
});
scalez.notes.assign = (function scalez$notes$assign(named_notes,notes){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7638_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(scalez.notes.find_or_note(named_notes,p1__7638_SHARP_),cljs.core.cst$kw$step,cljs.core.cst$kw$step.cljs$core$IFn$_invoke$arity$1(p1__7638_SHARP_),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$range,cljs.core.cst$kw$range.cljs$core$IFn$_invoke$arity$1(p1__7638_SHARP_)], 0));
}),notes);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$flat_DASH_of_DASH_name.cljs$core$IFn$_invoke$arity$1(n)),"b"].join('');
}
} else {
var or__4126__auto__ = cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(n);
if(cljs.core.truth_(or__4126__auto__)){
...
scalez.notes.Db = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$6((1),(12),"western","C#/Db","C","D");
scalez.notes.D = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$4((2),(12),"western","D");
scalez.notes.Eb = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$6((3),(12),"western","D#/Eb","D","E");
...
scalez.notes.Gb = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$6((6),(12),"western","F#/Gb","F","G");
scalez.notes.G = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$4((7),(12),"western","G");
scalez.notes.Ab = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$6((8),(12),"western","G#/Ab","G","A");
scalez.notes.A = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$4((9),(12),"western","A");
scalez.notes.Bb = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$6((10),(12),"western","A#/Bb","A","B");
