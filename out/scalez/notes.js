...
switch (G__1290) {
case 5:
return scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]));

break;
case 7:
return scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),(arguments[(5)]),(arguments[(6)]));
...
(scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5 = (function (step,range,set,type,name){
return new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$step,step,cljs.core.cst$kw$range,range,cljs.core.cst$kw$type,type,cljs.core.cst$kw$set,set,cljs.core.cst$kw$name,name], null);
}));

(scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7 = (function (step,range,set,type,name,sharp_of_name,flat_of_name){
return new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$step,step,cljs.core.cst$kw$range,range,cljs.core.cst$kw$name,name,cljs.core.cst$kw$set,set,cljs.core.cst$kw$type,type,cljs.core.cst$kw$sharp_DASH_of_DASH_name,sharp_of_name,cljs.core.cst$kw$flat_DASH_of_DASH_name,flat_of_name], null);
}));

(scalez.notes.named_note.cljs$lang$maxFixedArity = 7);
...
scalez.notes.shift_QMARK_ = (function scalez$notes$shift_QMARK_(n1,n2){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$type.cljs$core$IFn$_invoke$arity$1(n2),cljs.core.cst$kw$static)){
return scalez.notes.unshift(n1,n2);
} else {
return n2;
}
});
scalez.notes.find_note = (function scalez$notes$find_note(notes,root_note,n){
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__1297_SHARP_){
return scalez.notes.same_note_QMARK_(scalez.notes.shift_QMARK_(root_note,p1__1297_SHARP_),n);
}),notes));
});
scalez.notes.find_or_note = (function scalez$notes$find_or_note(notes,root_note,n){
var or__4126__auto__ = scalez.notes.find_note(notes,root_note,n);
...
scalez.notes.assign = (function scalez$notes$assign(named_notes,root_note,notes){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1299_SHARP_){
return scalez.notes.find_or_note(named_notes,root_note,p1__1299_SHARP_);
}),notes);
});
...
scalez.notes.named_notes = (function scalez$notes$named_notes(named_notes,root_note,notes){
return scalez.notes.assign(named_notes,root_note,notes);
});
scalez.notes.C = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((0),(12),"western",cljs.core.cst$kw$static,"C");
scalez.notes.Db = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7((1),(12),"western",cljs.core.cst$kw$static,"C\u266F/D\u266D","C","D");
scalez.notes.D = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((2),(12),"western",cljs.core.cst$kw$static,"D");
scalez.notes.Eb = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7((3),(12),"western",cljs.core.cst$kw$static,"D\u266F/E\u266D","D","E");
scalez.notes.E = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((4),(12),"western",cljs.core.cst$kw$static,"E");
scalez.notes.F = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((5),(12),"western",cljs.core.cst$kw$static,"F");
scalez.notes.Gb = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7((6),(12),"western",cljs.core.cst$kw$static,"F\u266F/G\u266D","F","G");
scalez.notes.G = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((7),(12),"western",cljs.core.cst$kw$static,"G");
scalez.notes.Ab = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7((8),(12),"western",cljs.core.cst$kw$static,"G\u266F/A\u266D","G","A");
scalez.notes.A = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((9),(12),"western",cljs.core.cst$kw$static,"A");
scalez.notes.Bb = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$7((10),(12),"western",cljs.core.cst$kw$static,"A\u266F/B\u266D","A","B");
scalez.notes.B = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((11),(12),"western",cljs.core.cst$kw$static,"B");
...
scalez.notes.a = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((0),(12),"cyclic",cljs.core.cst$kw$relative,"0");
scalez.notes.b = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((1),(12),"cyclic",cljs.core.cst$kw$relative,"1");
scalez.notes.c = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((2),(12),"cyclic",cljs.core.cst$kw$relative,"2");
scalez.notes.d = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((3),(12),"cyclic",cljs.core.cst$kw$relative,"3");
scalez.notes.e = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((4),(12),"cyclic",cljs.core.cst$kw$relative,"4");
scalez.notes.f = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((5),(12),"cyclic",cljs.core.cst$kw$relative,"5");
scalez.notes.g = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((6),(12),"cyclic",cljs.core.cst$kw$relative,"6");
scalez.notes.h = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((7),(12),"cyclic",cljs.core.cst$kw$relative,"7");
scalez.notes.i = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((8),(12),"cyclic",cljs.core.cst$kw$relative,"8");
scalez.notes.j = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((9),(12),"cyclic",cljs.core.cst$kw$relative,"9");
scalez.notes.k = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((10),(12),"cyclic",cljs.core.cst$kw$relative,"10");
scalez.notes.l = scalez.notes.named_note.cljs$core$IFn$_invoke$arity$5((11),(12),"cyclic",cljs.core.cst$kw$relative,"11");
