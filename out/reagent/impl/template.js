...
var G__6082 = o;
goog.object.set(G__6082,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__6084__i = 0, G__6084__a = new Array(arguments.length -  0);
while (G__6084__i < G__6084__a.length) {G__6084__a[G__6084__i] = arguments[G__6084__i + 0]; ++G__6084__i;}
  args = new cljs.core.IndexedSeq(G__6084__a,0,null);
} 
...
var G__6086 = o;
goog.object.set(G__6086,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__6088__i < G__6088__a.length) {G__6088__a[G__6088__i] = arguments[G__6088__i + 0]; ++G__6088__i;}
  args = new cljs.core.IndexedSeq(G__6088__a,0,null);
} 
return G__6087__delegate.call(this,args);};
G__6087.cljs$lang$maxFixedArity = 0;
G__6087.cljs$lang$applyTo = (function (arglist__6089){
...
var G__6090 = props;
var G__6090__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6090,cljs.core.cst$kw$id,id):G__6090);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6090__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__6091 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6091,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__6091;
}
})(),id_class);
...
var G__6092 = (cljs.core.count(argv) - first_child);
switch (G__6092) {
case (0):
...
break;
case (1):
var G__6093 = component;
var G__6094 = jsprops;
var G__6095 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__6093,G__6094,G__6095);
...
var vec__6097 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6097,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6097,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6097,(2),null);
...
var temp__5461__auto___6100 = reagent.impl.util.react_key_from_vec(v);
if((temp__5461__auto___6100 == null)){
} else {
var key_6101 = temp__5461__auto___6100;
(jsprops.key = key_6101);
}
...
var temp__5461__auto___6104 = reagent.impl.util.react_key_from_vec(v);
if((temp__5461__auto___6104 == null)){
} else {
var key_6105 = temp__5461__auto___6104;
(jsprops.key = key_6105);
}

var G__6102 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__6103 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__6102,G__6103);
});
/**
...
var temp__5461__auto___6106 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5461__auto___6106 == null)){
} else {
var key_6107 = temp__5461__auto___6106;
(jsprops.key = key_6107);
}
...
var temp__5461__auto___6108 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5461__auto___6108 == null)){
} else {
var key_6109 = temp__5461__auto___6108;
(jsprops.key = key_6109);
}
...
var temp__5461__auto___6110 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5461__auto___6110 == null)){
} else {
var key_6111 = temp__5461__auto___6110;
(jsprops.key = key_6111);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6112_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__6112_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__6113 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6113,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6113,(1),null);
...
break;
default:
var G__6118 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__6119 = compiler;
v = G__6118;
compiler = G__6119;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template6123 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template6123 = (function (opts,id,fn_to_element,meta6124){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta6124 = meta6124;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template6123.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_6125,meta6124__$1){
var self__ = this;
var _6125__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template6123(self__.opts,self__.id,self__.fn_to_element,meta6124__$1));
}));

(reagent.impl.template.t_reagent$impl$template6123.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_6125){
var self__ = this;
var _6125__$1 = this;
return self__.meta6124;
}));

(reagent.impl.template.t_reagent$impl$template6123.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template6123.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template6123.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template6123.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template6123.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta6124], null);
}));

(reagent.impl.template.t_reagent$impl$template6123.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template6123.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template6123");

(reagent.impl.template.t_reagent$impl$template6123.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template6123");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template6123.
 */
reagent.impl.template.__GT_t_reagent$impl$template6123 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template6123(opts__$1,id__$1,fn_to_element__$1,meta6124){
return (new reagent.impl.template.t_reagent$impl$template6123(opts__$1,id__$1,fn_to_element__$1,meta6124));
});

}

return (new reagent.impl.template.t_reagent$impl$template6123(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
