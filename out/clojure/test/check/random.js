...
var clojure$test$check$random$IRandom$rand_long$dyn_3428 = (function (rng){
...
return (m__4429__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4429__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4429__auto__.call(null,rng));
} else {
var m__4426__auto__ = (clojure.test.check.random.rand_long["_"]);
if((!((m__4426__auto__ == null)))){
return (m__4426__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4426__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4426__auto__.call(null,rng));
} else {
...
return clojure$test$check$random$IRandom$rand_long$dyn_3428(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_3429 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_3429(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_3430 = (function (rng){
var x__4428__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_3430(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_3431 = (function (rng,n){
var x__4428__auto__ = (((rng == null))?null:rng);
var m__4429__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__4428__auto__)]);
if((!((m__4429__auto__ == null)))){
return (m__4429__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4429__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4429__auto__.call(null,rng,n));
} else {
var m__4426__auto__ = (clojure.test.check.random.split_n["_"]);
if((!((m__4426__auto__ == null)))){
return (m__4426__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4426__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4426__auto__.call(null,rng,n));
} else {
...
return clojure$test$check$random$IRandom$split_n$dyn_3431(rng,n);
}
});
...
var G__3432 = z;
if(((24) > (function (){var G__3433 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__3433) : clojure.test.check.random.longs.bit_count.call(null,G__3433));
})())){
return clojure.test.check.random.longs.bit_xor(G__3432,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__3432;
}
});
...
var G__3436 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__3437 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__3436;
ret = G__3437;
continue;
}
...
return cljs.core._write(writer__4370__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
}));
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__4126__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
return (function (){
return cljs.core.cst$kw$returned.cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__3438){
var map__3439 = p__3438;
var map__3439__$1 = (((((!((map__3439 == null))))?(((((map__3439.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3439.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__3439):map__3439);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__3439__$1,cljs.core.cst$kw$state);
var vec__3441 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3441,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__3441,(1),null);
